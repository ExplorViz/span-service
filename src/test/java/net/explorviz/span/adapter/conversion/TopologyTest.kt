...
class TopologyTest {
        ...
        val config =
                Properties().apply {
                    ...
                    put(
                            ...
                            SpecificAvroSerde::class.java.name
                    )
                    put(
        ...
        val attributes =
                listOf(
                        ...
                        KeyValue.newBuilder()
                                ...
                                .setValue(
                                        AnyValue.newBuilder()
                                                .setStringValue("net.example.Bar.foo()")
                                                .build()
                                )
                                .build(),
                )
    ...
    //
    //        assertEquals(attrs[AttributesReader.LANDSCAPE_TOKEN], result.landscapeToken, "Invalid
    // token")
    //        assertEquals(
    ...
    //        )
    //        assertEquals(attrs[AttributesReader.HOST_IP], result.hostIpAddress, "Invalid host ip
    // address")
    //        assertEquals(attrs[AttributesReader.HOST_NAME], result.hostname, "Invalid host name")
    //        assertEquals(attrs[AttributesReader.APPLICATION_NAME], result.appName, "Invalid
    // application name")
    //        assertEquals(attrs[AttributesReader.APPLICATION_INSTANCE_ID], result.appInstanceId,
    // "Invalid application pid")
    //        assertEquals(attrs[AttributesReader.APPLICATION_LANGUAGE], result.appLanguage,
    // "Invalid application language")
    //        assertEquals(attrs[AttributesReader.METHOD_FQN], result.fullyQualifiedOperationName,
    ...
    //        inputTopic!!.pipeInput(testSpan.spanId.toByteArray(), containeredSpan.toByteArray())
    //
    //        assertFalse(spanOutputTopic!!.isEmpty, "Output topic is empty, but should contain a
    // data record")
    //
    ...
    //        assertEquals(expectedStartTimeInMillisec, result.startTimeEpochNano, "Invalid start
    // time")
    ...
    //        assertEquals(resultFromStateStore, expectedTokenEvent, "Invalid token event in state
    // store")
    //    }
    //
    //    @Test
    ...
    //        assertFalse(resultFromStateStore2, "Invalid token event in state store, should be
    // null")
    //    }
    //
    //    @Test
    ...
    //        }
    //
    //        assertEquals(0, tokenEventStore!!.approximateNumEntries(), "State store not empty, but
    // should be empty")
    //
    //        val tokenService = TokenService(tokenEventStore!!)
    //
